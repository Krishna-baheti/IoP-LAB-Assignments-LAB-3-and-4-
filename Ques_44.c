...
Description : Taking input from user the consumption of electricity in units
and then using the concept of if-else to print the amount to be paid by user
*/
